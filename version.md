...
- Исправлен плавающий краш при вызове метода `setup`

### 1.2.3

- Обновлена версия SPaySdk до 3.2.3
- Исправление багов и внутренние доработки

### 1.2.2

- Добавлены правила proguard
- Исправлен баг с пустой WebView при подтверждении ОТП

### 1.2.1

- Обновлена версия SPaySdk до 3.0.6
- Исправлена оплата новой картой с некоторыми банками

<br>

### 1.2.0

- Обновлена версия SPaySdk до 3.0.5
- Добавлена возможность кастомизации UI
...
- Исправлено поведение выбора оплаты новой картой, при отсутствии других вариантов
